...
set :passenger_environment_variables, path: "/#{fetch(:passenger_path)}/bin:$PATH"
set :passenger_restart_command, "/#{fetch(:passenger_path)}/bin/passenger-config restart-app"
