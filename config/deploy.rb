...
# Change these
server '192.168.0.50', port: 80, roles: [:web, :app, :db], primary: true
...
# set :deploy_to,       "/home/deploy/apps/weather-rails"
set :ssh_options,     forward_agent: true, user: 'brbrr', keys: %w(~/.ssh/id_rsa.pub)
